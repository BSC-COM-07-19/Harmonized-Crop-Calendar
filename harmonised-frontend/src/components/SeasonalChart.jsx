...
import MarketPricing from './MarketPricing'; // Import the MarketPricing component
...
const SeasonalChart = () => {
  ...
  const [showMarketPricing, setShowMarketPricing] = useState(false); // State to toggle MarketPricing dropdown
  ...
  const toggleMarketPricing = () => {
    setShowMarketPricing(!showMarketPricing); // Toggle the state to show/hide MarketPricing dropdown
  };
    ...
    <>
      <div className="seasonal-chart-container">
        ...
        <div className="button-container">
          ...
          <button className="button" onClick={toggleMarketPricing}>
            ACTIVITIES {showMarketPricing ? '▲' : '▼'}
          </button>
        </div>
      ...
      {showMarketPricing && (
        <div className="market-pricing-container">
          <MarketPricing />
        </div>
      )}
    </>
